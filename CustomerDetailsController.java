...
public class CustomerDetailsController {
    ...
    public ResponseEntity withdraws(@RequestBody CustomerDetailsDTO cd, @PathVariable Integer amount) throws CustomerFoundsException {
        logger.info("Request in withdraws ");
        customerService.withdraws(cd,amount);
